...
public final class JBGData {
  ...
  private @Nullable JBGPurchaseOptionMap purchaseOptions = null;
  private double minCostPerHitPoint = Double.MAX_VALUE;

  private AbstractJBGAi jbgAi;
  public final AbstractJBGAi getJBGAi() {return jbgAi; } //because lombok Getter will make getJbgAi() instead
  private GameData data;
  private GamePlayer player;

  public void initialize(final AbstractJBGAi jbgAi) {
    hiddenInitialize(jbgAi, jbgAi.getGameData(), jbgAi.getGamePlayer(), false);
  }

  public void initializeSimulation(
      final AbstractJBGAi jbgAi, final GameData data, final GamePlayer player) {
    hiddenInitialize(jbgAi, data, player, true);
  }
  ...
  private void hiddenInitialize(
    ...
    purchaseOptions = new JBGPurchaseOptionMap(player, data);
  ...
  private double getMinCostPerHitPoint(final List<JBGPurchaseOption> landPurchaseOptions) {
    double minCostPerHitPoint = Double.MAX_VALUE;
    for (final JBGPurchaseOption ppo : landPurchaseOptions) {
