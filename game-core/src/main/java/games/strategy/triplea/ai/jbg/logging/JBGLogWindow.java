...
@Log
class JBGLogWindow extends JDialog {
  ...
  JBGLogWindow(final TripleAFrame frame) {
    super(frame);
  ...
  private void formWindowOpened() {
    loadSettings(JBGLogSettings.loadSettings());
    this.pack();
  }

  /** Loads the settings provided and displays it in this settings window. */
  private void loadSettings(final JBGLogSettings settings) {
  ...
  JBGLogSettings newSettings() {
    final JBGLogSettings settings = new JBGLogSettings();
  ...
  private void restoreDefaultsButtonActionPerformed() {
    ...
    if (result == JOptionPane.OK_OPTION) {
      ...
      final JBGLogSettings defaultSettings = new JBGLogSettings();
  ...
  private void okButtonActionPerformed() {
    final JBGLogSettings settings = newSettings();
    JBGLogSettings.saveSettings(settings);
    this.setVisible(false);
  }

  private void cancelButtonActionPerformed() {
    final JBGLogSettings settings = JBGLogSettings.loadSettings();
    loadSettings(settings);
    this.setVisible(false);
  }

  private void settingsDetailsButtonActionPerformed() {
    final JDialog dialog = new JDialog(this, "JBG AI - Settings Details");
    String message = "";
  ...
  void addMessage(final String message) {
    try {
      ...
      log.log(Level.INFO, "Error adding JBG log message! Message: " + message, ex);
    }
  }
