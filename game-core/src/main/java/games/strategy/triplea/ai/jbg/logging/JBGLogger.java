...
public final class JBGLogger {
  ...
  /**
   * Some notes on using the JBG AI logger: First, to make the logs easily readable even when there
   * are hundreds of lines, I want every considerable step down in the call stack to mean more log
   * message indentation. For example, the base logs in the {@link AbstractJBGAi} class have no
   * indentation before them, but the base logs in the {@link
   * games.strategy.triplea.ai.jbg.JBGCombatMoveAi} class will have two spaces inserted at the
   ...
   * in the JBG AI class. Finest for messages showing details within a method that, for example,
