...
public class JBGTerritory {
  ...
  private JBGBattleResult maxBattleResult;
  ...
  private JBGBattleResult battleResult;
  ...
  private JBGBattleResult minBattleResult;
  ...
  public JBGTerritory(final Territory territory, final JBGData jbgData) {
    this.territory = territory;
    this.jbgData = jbgData;
    maxUnits = new ArrayList<>();
    units = new ArrayList<>();
    bombers = new ArrayList<>();
    maxBattleResult = new JBGBattleResult();
    value = 0;
    seaValue = 0;
    canHold = true;
    canAttack = false;
    ...
    minBattleResult = new JBGBattleResult();
  ...
  JBGTerritory(final JBGTerritory patd, final JBGData jbgData) {
    ...
    final Set<Unit> defenders =
        new HashSet<>(
            CollectionUtils.getMatches(
                cantMoveUnits, JBGMatches.unitIsOwnedCarrier(player).negate()));
  ...
  public void estimateBattleResult(final JBGOddsCalculator calc, final GamePlayer player) {
    setBattleResult(
  ...
  public void setBattleResult(final JBGBattleResult battleResult) {
    this.battleResult = battleResult;
    if (battleResult == null) {
      currentlyWins = false;
    } else if (battleResult.getWinPercentage() >= jbgData.getWinPercentage()
        && battleResult.isHasLandUnitRemaining()) {
      currentlyWins = true;
    }
  }

  public JBGBattleResult getBattleResult() {
    return battleResult;
  }
  ...
  public void setMinBattleResult(final JBGBattleResult minBattleResult) {
    this.minBattleResult = minBattleResult;
  }

  public JBGBattleResult getMinBattleResult() {
  ...
  public void setMaxBattleResult(final JBGBattleResult maxBattleResult) {
    this.maxBattleResult = maxBattleResult;
  }

  public JBGBattleResult getMaxBattleResult() {
