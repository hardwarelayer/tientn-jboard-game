...
import games.strategy.engine.framework.KanjiDataFileUtils;
 ...
 */
@Builder
public final class JBGKanjiFileSelector {
   ...
   * pop-up.
   */
  public Optional<File> selectKanjiFile(final Frame owner) {
    ...
    fileDialog.setFilenameFilter((dir, name) -> KanjiDataFileUtils.isCandidateFileName(name));
