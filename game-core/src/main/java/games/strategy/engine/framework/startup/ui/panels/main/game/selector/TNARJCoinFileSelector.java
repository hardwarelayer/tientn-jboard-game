...
import games.strategy.engine.framework.TNARJCoinFileUtils;
 ...
 */
@Builder
public final class TNARJCoinFileSelector {
   ...
   * pop-up.
   */
  public Optional<File> selectJCoinFile(final Frame owner) {
    ...
    fileDialog.setFile("*.tfmt");
    fileDialog.setFilenameFilter((dir, name) -> TNARJCoinFileUtils.isCandidateFileName(name));
